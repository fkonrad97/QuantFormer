...
def finetune_on_real_world(pretrained_model_path, real_data_folder="data/real_world/iv_data", device=torch.device("cuda" if torch.cuda.is_available() else "cpu")):
    ...
    torch.save(model.state_dict(), "realworld_finetuned.pth")
    print("Finetuning complete. Model saved to realworld_finetuned.pth")
